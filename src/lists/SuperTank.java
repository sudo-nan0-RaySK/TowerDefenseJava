...
public class SuperTank extends Sprite {
    ...
    private static final String TANK_IMAGE = "res/images/supertank.png";
    private static final String TANK_PROJECTILE_IMAGE = "res/images/supertank_projectile.png";
    private final long COOL_DOWN_PERIOD = 500;
    private final int DAMAGE = 3;
    private final double SPEED = 2.0;
    private final double EFFECT_RADIUS = 150;
